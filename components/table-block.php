...
<section class='c12 py4'>
  <div class='mw70 mxa px4'>
    <div class='x xw xac xjb pb1 mb1 bb1lg fsB'>
      <h3 class='db mb0 c4'><?php echo $h1; ?></h3>
      <h3 class='db mb0 c3'><?php echo $h2; ?></h3>
      <h3 class='db mb0 c3'><?php echo $h3; ?></h3>
    </div> 
    <?php 
      if (have_rows('table')) : while (have_rows('table')) : the_row();
        ...
        <div class='x xw xac xjb lh1-5 fsB'>
