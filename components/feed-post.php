  ...
  <a href='<?php echo $post_url; ?>'>
    <div class='mb1'>
      <picture>
        ...
        <source media="(min-width: 800px)" srcset="<?php echo $post_photo['sizes']['large'] ?>" type="image/jpeg" /> 
        <img class='c12' src='<?php echo $post_photo['sizes']['medium'] ?>' alt="<?php echo $post_photo['caption'] ?>" />
      </picture> 
    </div> 
